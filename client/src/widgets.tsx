...
class FormInput extends Component<{
  ...
  render() {
    ...
    const { type, value, width, maxlength, onChange, ...rest } = this.props;
    return (
      <input
        {...rest}
...
class FormTextarea extends React.Component<{
  ...
  render() {
    ...
    // For further information, see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax
    const { value, width, maxlength, onChange, ...rest } = this.props;

    

    return <textarea style={{width:width}}{...rest} className="form-control" value={value} maxLength={maxlength} onChange={onChange} />;
  }
}
